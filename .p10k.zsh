# Generated by Powerlevel10k configuration wizard on 2022-01-14 at 17:31 PST.
...
() {
  ...
  # typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='comm-*|health-*|kubectl|k|helm|kubens|kubectx|oc|istioctl|kogito|k9s|helmfile|flux|fluxctl|stern'
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_ADMIN_FOREGROUND=166
  typeset -g POWERLEVEL9K_KUBECONTEXT_ADMIN_VISUAL_IDENTIFIER_EXPANSION='🔨'
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEV_FOREGROUND=120
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEV_VISUAL_IDENTIFIER_EXPANSION='🍏'
  typeset -g POWERLEVEL9K_KUBECONTEXT_PIE_FOREGROUND=226
  typeset -g POWERLEVEL9K_KUBECONTEXT_PIE_VISUAL_IDENTIFIER_EXPANSION='🥧'
  typeset -g POWERLEVEL9K_KUBECONTEXT_PROD_FOREGROUND=202
  typeset -g POWERLEVEL9K_KUBECONTEXT_PROD_VISUAL_IDENTIFIER_EXPANSION='🚨'
  #   typeset -g POWERLEVEL9K_KUBECONTEXT_ADMIN_CONTENT_EXPANSION='> ${P9K_CONTENT} <'
  ...
  # Custom prefix.
  typeset -g POWERLEVEL9K_KUBECONTEXT_PREFIX='%088F'
